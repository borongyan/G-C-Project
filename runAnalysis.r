...
# Clean up the workspace
  ...
  #Set the working directory to the location where the UCI HAR Dataset was unzipped
   ...
   setwd('G:/Coursera/Getting Cleaning Data/Course Project/Data/UCI HAR Dataset');

   # Load the files

 #Load file "features.txt"
  features = read.table('./features.txt',header=FALSE); 

 #Load file "activity_labels.txt"
  activityType = read.table('./activity_labels.txt',header=FALSE); 

 #Load file "subject_train.txt"
 subjectTrain = read.table('./train/subject_train.txt',header=FALSE); 

  #Load file "x_train.txt"
  xTrain = read.table('./train/x_train.txt',header=FALSE); 

 #Load file "y_train.txt"
...
# Load the test data
 ...
 #Load file "subject_test.txt"
  subjectTest = read.table('./test/subject_test.txt',header=FALSE); 

  #Load file "x_test.txt"
  xTest = read.table('./test/x_test.txt',header=FALSE); 

  #Load file "y_test.txt"
...
# Merging the tidyData with activityType to include descriptive activity names
  ...
  write.table(tidyData, 'G:/Coursera/Getting Cleaning Data/Course Project/tidyData.txt',row.names=TRUE,sep='\t');
